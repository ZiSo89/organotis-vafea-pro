/**
 * Help System - Simple Modal with Instructions
 * Floating button that opens help modal
 */
...
const HelpSystem = {
  ...
  helpContent: {
    ...
    jobs: {
      title: '💼 Εργασίες',
      content: `
        <h4>Δημιουργία νέας εργασίας:</h4>
        <ol>
      ...
      <div class="help-modal-overlay" id="helpModalOverlay">
        <div class="help-modal">
          <div class="help-modal-header">
            ...
            <button class="help-modal-close" onclick="HelpSystem.closeHelpModal()">
  ...
  setupHelpNavigation() {
    ...
    navItems.forEach(item => {
      item.addEventListener('click', () => {
        ...
        contentArea.innerHTML = this.renderHelpSection(section);
